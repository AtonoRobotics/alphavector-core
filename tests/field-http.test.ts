...
describe("field HTTP surface against pinned alphavector-re", () => {
  ...
  it("does not expose Architect, models, prompts, Temporal, or tools on field routes", async () => {
    ...
    for (const path of [
      ...
      "/field/adapter-router",
      "/field/set-adapter-router",
      "/field/adapter-aggregator",
      "/field/set-adapter-aggregator",
      "/field/bind-connector",
      "/field/edit-connector-bind",
      "/field/set-connector-credentials",
